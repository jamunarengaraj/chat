  ...
  return (
    <div
      ...
      style={{
        backgroundColor: " #fff",
        // backgroundImage:
        //   "url(https://source.unsplash.com/qDbaQGEwPtI/2400x1823)",
      }}
    >
      <form
        class="signup-form
      ...
      >
        {/* <h3 class="mb-1 text-md text-[#1A2421]/80">Signup required!</h3> */}
        ...
        <img
          ...
          className="rounded-full w-[70px] h-[70px] ml-4 mt-2 mx-auto "
        />
        ...
        >
          ...
          <input
            class="form-input 
                    ...
                    [ py-2 pr-3 md:py-4 md:pr-4 lg:py-4 lg:pr-4 pl-12 ] 
        ...
        >
          ...
          <input
            class="block w-full rounded-lg leading-none focus:outline-none placeholder-black/50 
                    [ transition-colors duration-200 ] 
                    [ py-2 pr-3 md:py-4 md:pr-4 lg:py-4 lg:pr-4 pl-12 ] 
                    [ bg-black/20 focus:bg-black/25 ] 
                    [ text-[#333] focus:text-black ]"
        ...
        {/* <div class="form-footer mt-8 text-center">
          <p class="text-xs">or Sign in with</p>
          ...
          <ul class="form-list mt-4 flex justify-center">
            ...
            <li class="mx-1">
              <a
                href="#"
                class="rounded-full bg-[#1DA1F2] hover:shadow-lg
                    [ transform transition hover:-translate-y-1 ]
                    [ w-10 h-10 ]
                    [ flex justify-center items-center ]"
              >
            ...
            <li class="mx-1">
              <a
                href="#"
                class="rounded-full bg-[#4267B2] hover:shadow-lg
                    [ transform transition hover:-translate-y-1 ]
                    [ w-10 h-10 ]
                    [ flex justify-center items-center ]"
              >
